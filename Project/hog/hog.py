...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    # BEGIN PROBLEM 5
    "*** YOUR CODE HERE ***"
    while 0 <= score0 < goal and 0 <= score1 < goal:
        if who == 0:
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    def say(score0, score1):
        ...
        if temp > running_high:
            running_high_update = temp
            print(running_high_update, "point(s)! The most yet for Player", who)
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    ...
    if score + free_bacon(opponent_score) >= 100:
        return 0
    elif extra_turn(score + free_bacon(opponent_score), opponent_score) or free_bacon(opponent_score) > 8:
        return 0
    else:
        return 4
    # END PROBLEM 12
